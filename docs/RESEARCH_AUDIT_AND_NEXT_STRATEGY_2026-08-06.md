...
**Understated opportunity.** The factorization probably records a decomposition
of the adjoint representation into invariant subspaces under the balanced
sensor's residual symmetry. A conceptual decomposition could explain the
recurring determinant, trace, and inverse-trace invariants without large
symbolic elimination.

**What is proved separately.** The signed-star theorem and the Cayley-null
four-correlation edge theorem have exact positivity certificates. A rational
counterexample exactly falsifies coordinatewise residual removal.

**What remains open.** Nonzero Cayley coordinate in the one-edge family, two
more residual Cholesky correlations, the unrestricted Gram--Cayley inequality,
and global five-query D-optimality across every allocation and nonorthogonal
frame.
...
2. Decompose `so(8)` into its irreducible/isotypic blocks under that stabilizer.
3. Derive each repeated quadratic/cubic characteristic factor from those
   blocks.
4. Express the variable-Cayley one-edge information matrix in the same basis.
5. Attempt the remaining determinant inequality blockwise before another giant
   Bernstein expansion.

**Success condition:** a human-readable derivation of the characteristic law
and a reduced exact certificate for the variable-Cayley determinant.
